...
public partial class MainPage : ContentPage
{
    ...
    public MainPage()
    {
        ...
        cpu = new Giocatore(new GiocatoreHelperCpu2(e.GetCartaBriscola()), Preferences.Get("nomeCpu", "numerona"), 3);
        primo = g;
        secondo = cpu;
    ...
    {
        g.SetNome(Preferences.Get("nomeUtente", "numerone"));
        cpu.SetNome(Preferences.Get("nomeCpu", "numerona"));
        secondi = (UInt16)Preferences.Get("secondi", 5);
        avvisaTalloneFinito = Preferences.Get("avvisaTalloneFinito", true);
        briscolaDaPunti = Preferences.Get("briscolaDaPunti", false);
        t.Interval = TimeSpan.FromSeconds(secondi);
